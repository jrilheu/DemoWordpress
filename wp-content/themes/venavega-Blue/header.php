		...
		<header id="masthead" class="site-header" role="banner">
			...
			<div style="margin: 5px 0;">
				<a id="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/images/headers/logo.png" alt="Logo" style="width:160px;" />
				</a>
			</div>
			<div id="navbar" class="navbar">
				<nav id="site-navigation" class="navigation main-navigation dark-blue" role="navigation">
